...
# on both sides, which is consistent. (Ported from main's 8d718fd: the live
# site had the backend half configured and no button, because every deploy
# built the bundle without this value.)
